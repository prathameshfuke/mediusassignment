  ...
  return (
    <footer className="bg-white border-t border-border pt-16 pb-12 mt-auto">
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-10 mb-12">
          ...
          <div className="lg:col-span-2 flex flex-col space-y-4">
            <Link href="/" className="flex items-center space-x-1 focus:outline-none">
              <span className="font-serif text-[28px] font-bold text-better-green lowercase tracking-tighter">
                better
              </span>
            ...
            <div className="flex items-center space-x-4 pt-2">
              <a href="#" className="text-text-secondary hover:text-better-green transition-colors" aria-label="Facebook">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path>
                </svg>
              </a>
              <a href="#" className="text-text-secondary hover:text-better-green transition-colors" aria-label="Twitter">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <path d="M23 3a10.9 10.9 0 0 1-3.14 1.53 4.48 4.48 0 0 0-7.86 3v1A10.66 10.66 0 0 1 3 4s-4 9 5 13a11.64 11.64 0 0 1-7 2c9 5 20 0 20-11.5a4.5 4.5 0 0 0-.08-.83A7.72 7.72 0 0 0 23 3z"></path>
                </svg>
              </a>
              <a href="#" className="text-text-secondary hover:text-better-green transition-colors" aria-label="Instagram">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <a href="#" className="text-text-secondary hover:text-better-green transition-colors" aria-label="LinkedIn">
                <svg className="w-5 h-5" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          {FOOTER_SECTIONS.map((section) => (
            <div key={section.title} className="flex flex-col space-y-4">
              <h3 className="font-sans font-semibold text-text-primary text-sm uppercase tracking-wider">
                {section.title}
              </h3>
              <ul className="flex flex-col space-y-2.5">
                {section.links.map((link) => (
                  <li key={link.label}>
                    <Link
                      href={link.href}
                      className="text-text-secondary hover:text-better-green text-sm transition-colors duration-200"
                    >
                      {link.label}
                    </Link>
                  </li>
        ...
        <div className="flex flex-col space-y-6 text-xs text-text-secondary leading-relaxed">
          <p>
          ...
          <p className="border-t border-border pt-4 text-[10px] text-gray-400">
